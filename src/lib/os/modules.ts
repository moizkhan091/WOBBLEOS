...
export const MODULES: Record<string, ModuleDef> = {
  ...
  optimizer: { id: "optimizer", label: "Self-Optimizer", title: "Controlled Dream / Self-Optimizer", icon: "Gauge", status: "wired", api: "/api/optimizer", tagline: "The OS studies its OWN performance — QA failures, revision load, dead letters, provider cost — and PROPOSES evidence-backed improvements. Nothing changes silently: every proposal needs a passing historical test + your explicit approval, is monitored vs a baseline, and rolls back if it degrades." },
