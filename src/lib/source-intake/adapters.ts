...
// SSRF URL safety lives in the shared security module (also used by the n8n outbound handoff).
import { isBlockedHost, assertFetchableUrl } from "@/lib/security/url-guard";
...
// SSRF URL safety re-exported so existing callers/tests keep importing it from the ingestion adapters.
