...
const reg = (over: Partial<RegisteredDepartment>): RegisteredDepartment => ({ slug: "x", name: "X", status: "active", healthStatus: "unknown", purpose: "p", orchestratorAgentSlug: null, outboundProducts: [], downstreamConsumers: [], ...over });
