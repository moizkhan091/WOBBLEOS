...
- **Branch:** `main` · **HEAD:** `8b16ac4` (graphs are a real runtime-driven execution backbone) · atop `54ced1e` (approval-effect coverage COMPLETE), `47459ae` (durable handoff runtime), `5f90e2a` (outbox foundation).
...
- **Gate at HEAD:** typecheck 0 · **581 tests (78 files)** · build 0. Real-OpenRouter smoke PASS; real-DB proofs PASS for checkpoints, payments ledger, **handoff runtime**, **approval-effects outbox**, **memory-update outbox**, and **graph→handoff execution backbone**.
