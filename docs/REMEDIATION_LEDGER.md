...
- **Latest migration:** `0032_departments` (34 applied to the local dev DB; zero drift). **Gate:** typecheck 0 · **600 tests (80 files)** · build 0. Real-OpenRouter smoke PASS; real-DB proofs PASS for checkpoints, payments ledger, **handoff runtime**, **approval-effects outbox**, **memory-update outbox**, **graph→handoff execution backbone**, **Command Centre handoff ops**, **department roll-up**, and **department domain model**.
